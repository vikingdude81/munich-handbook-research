...
class Spirit(BaseModel):
    id: int = Field(..., description="Unique identifier for the spirit")
    name: str = Field(..., min_length=1, max_length=256, description="Name of the spirit")
    experiments: list[Experiment] = Field(default_factory=list, description="List of associated experiments")
